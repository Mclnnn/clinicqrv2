    ...
    return (
        ...
        >
            ...
            <div className="mt-6 grid gap-5 xl:grid-cols-2">
                ...
                <Stage number="3" title="Clinic-head decision" icon={ClipboardCheck} tone="border-emerald-300/30" subtitle="A human decision is required; ML only provides decision support.">
                ...
                <Stage number="4" title="Prevention event follow-through" icon={CalendarCheck} tone="border-amber-300/30" subtitle="Approved prevention activities can be turned into QR-attendance events.">
